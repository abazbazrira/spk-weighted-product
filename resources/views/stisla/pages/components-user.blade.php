                    ...
                    <div class="card author-box card-primary">
                        <div class="card-body">
                            <div class="author-box-left">
                                ...
                                <a href="#" class="btn btn-primary follow-btn mt-3" data-follow-action="alert('follow clicked');" data-unfollow-action="alert('unfollow clicked');">Follow</a>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-unstyled-border list-unstyled-noborder">
                                <li class="media">
                                    <img alt="image" class="rounded-circle mr-3" width="70" src="{{ asset('img/avatar/avatar-1.png') }}">
                                ...
                                <li class="media">
                                    <img alt="image" class="rounded-circle mr-3" width="70" src="{{ asset('img/avatar/avatar-2.png') }}">
                                    <div class="media-body">
                                        <div class="media-right">
                                ...
                                <li class="media">
                                    <img alt="image" class="rounded-circle mr-3" width="70" src="{{ asset('img/avatar/avatar-3.png') }}">
                                    <div class="media-body">
                                        <div class="media-right">
                                            <div class="text-primary">Approved</div>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled user-progress list-unstyled-border list-unstyled-noborder">
                                <li class="media">
                                    <img alt="image" class="rounded-circle mr-3" width="50" src="{{ asset('img/avatar/avatar-1.png') }}">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img alt="image" class="rounded-circle mr-3" width="50" src="{{ asset('img/avatar/avatar-5.png') }}">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img alt="image" class="rounded-circle mr-3" width="50" src="{{ asset('img/avatar/avatar-4.png') }}">
                                    <div class="media-body">
